...
var NewsletterForm = function NewsletterForm(_ref3) {
  ...
  return tinyletterUsername ? _react2.default.createElement(
    ...
    _react2.default.createElement(TinyIframe, { name: "tinyletterhider" })
  ) : _react2.default.createElement(
    FormWrapper,
    { outerCard: outerCard },
    _react2.default.createElement(
...
var TinyConfirmation = _styledComponents2.default.span(_templateObject9);

var TinyIframe = _styledComponents2.default.iframe(_templateObject10);
